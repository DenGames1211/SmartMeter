...
#define INFURA_API_KEY "39a811f95cf34c3c96be5b81afa8e080" //For production you will want to make your own API key, visit https://infura.io
...
public:
    ...
    Web3(long long networkId, const char* ip_address, unsigned short address_port);
    ...
    string getJson(const string* json);
